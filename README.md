...
Меня зовут Данияр.
Я — Backend/IOS/C++ -разработчик.

Если хотите написать мне личное сообщение, пишите на почту daniarkamaev@gmail.com
Я могу создать: серверную часть/IOS приложение/Электронную схему для вашего бизнеса (включая разработку фирменного стиля, дизайна и т. д.).
